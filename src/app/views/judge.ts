  ...
  root.replaceChildren(
    h('div', { class: 'card judge' },
      ...
      h('dl', { class: 'kv' },
        ...
        h('dt', {}, 'tests'), h('dd', {}, '47 Foundry (38 unit · 3 fuzz × 512 · 6 invariants × 64 × 32) · 36 vitest incl. 4 fast-check properties × 5,000 = 20,000 generated cases on the refund arithmetic and the log reducer · Playwright end-to-end on desktop + mobile incl. live mainnet reads'),
      ),
