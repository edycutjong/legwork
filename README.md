...
| Open orders | #1 `live` (0.02 USDC / 60 s / tip 0.01 — **four runs left for reviewers, first come** — topped up 2026-09-22 ([`0xf096ac36…`](https://explorer.arc.io/tx/0xf096ac36f0a4779bd48e6034ee02def385959cc66660910afea1d453cd36d752)); due since 2026-09-18, the missed periods are owed, so one wallet can take several back-to-back) · #2 `rejecting` (paused: its payee is the [`Rejector`](./contracts/Rejector.sol) `0x1c17C16177f2aC609440ea20c00D0e108F617c47`) · #3 `capped` (`maxGasPrice` 20 Gwei) |
